                  ...
                  <div class="config-section">
                    <div class="config-grid-two">
                      ...
                      <div class="config-item">
                        ...
                        <div class="config-value" :class="getInventoryColorClass(item.realTimeInventory, item.baseInventory)">
...
<!--                      </div>-->
                    ...
                    <div class="edit-button-container">
                      <el-button size="mini" type="primary" icon="el-icon-edit" @click="openEditDialog(item, 'win', index)">
                        修改
                      </el-button>
                    </div>
                  </div>
                  ...
                  <div class="card-content">
                    <div class="config-sections-row">
                      <div class="little-game-section">
                        <div class="section-subtitle">小游戏配置</div>
                        <div v-if="parseLittleGameDetails(item.littleGameProbabilityDetails)" class="little-game-config">
                          <div class="config-grid">
                            <!-- <div class="config-item">
                              <span class="config-label">小游戏概率</span>
                              <span class="config-value">{{
                                  formatPercentage(parseLittleGameDetails(item.littleGameProbabilityDetails).littleGameProbability)
                                }}</span>
                            </div> -->
                            <div class="config-item">
                              <span class="config-label">免费游戏概率</span>
                              <span class="config-value">{{
                                  formatPercentage(parseLittleGameDetails(item.littleGameProbabilityDetails).freeGameProbability)
                                }}</span>
                            </div>
                          </div>
                      ...
                      <div class="odds-ranges-section">
                        <div class="section-subtitle">倍率范围详情</div>
...
<!--                      </div>-->
                    ...
                    <div class="edit-button-container">
                      <el-button size="mini" type="primary" icon="el-icon-edit" @click="openEditDialog(item, 'lose', index)">
                        修改
                      </el-button>
                    </div>
                  </div>
    ...
    <!-- 修改游戏赔率范围弹窗 -->
    <el-dialog title="修改游戏赔率范围" :visible.sync="editRangeDialogOpen" width="800px" append-to-body :close-on-click-modal="false" :close-on-press-escape="false">
          ...
          <div class="edit-form-content">
            <div class="form-item">
              ...
              <div class="form-row">
                ...
                <div class="form-col">
                  <label>小游戏概率:</label>
                  <el-input-number v-model="editRangeFormData.littleGameProbability" :precision="2" :step="0.01" :min="0" :max="1"
                                   placeholder="请输入小游戏概率" style="width: 100%;"/>
                </div>
              </div>
              <div class="free-game-section">
                ...
                <div class="form-row">
                  <div class="form-col">
                    <label>免费游戏概率:</label>
                    <el-input-number v-model="editRangeFormData.freeGameProbability" :precision="2" :step="0.01" :min="0" :max="1"
                                     placeholder="请输入免费游戏概率" style="width: 100%;"/>
                  </div>
                </div>
                <div class="odds-range-form" v-for="(range, rangeIndex) in editRangeFormData.littleGameRanges" :key="'edit-little-range-' + rangeIndex">
                  <div class="range-form-row">
                    <div class="range-form-col">
                      <label>下限:</label>
                      <el-input-number v-model="range.multiplyingPowerRangeDown" :precision="1" :step="0.1" :min="0"
                ...
                <div class="add-range-btn">
                  <el-button type="primary" size="mini" icon="el-icon-plus"
                             @click="addEditLittleGameRange">添加倍率范围</el-button>
                </div>
              </div>
              <div class="odds-range-section">
                <div class="section-title">倍率范围配置</div>
                <div class="odds-range-form" v-for="(range, rangeIndex) in editRangeFormData.oddsRangeDetails" :key="'edit-range-' + rangeIndex">
                  <div class="range-form-row">
                    <div class="range-form-col">
                      <label>下限:</label>
                      <el-input-number v-model="range.multiplyingPowerRangeDown" :precision="1" :step="0.1" :min="0"
                    ...
                    <div class="range-form-col delete-btn-col">
                      <i class="el-icon-delete delete-icon"
                         ...
                         v-if="editRangeFormData.oddsRangeDetails.length > 1"></i>
                    </div>
                  </div>
                </div>
                <div class="add-range-btn">
                  <el-button type="primary" size="mini" icon="el-icon-plus"
                             @click="addEditOddsRange">添加倍率范围</el-button>
                </div>
              </div>
            </div>
          </div>
