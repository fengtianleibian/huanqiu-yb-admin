  ...
  <div class="app-container">
    ...
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="是否已读" prop="readStatus">
        <el-select v-model="queryParams.readStatus" placeholder="请选择状态" clearable size="small">
    ...
    <el-table v-loading="loading" ref="tables" :data="list">
      ...
      <el-table-column label="是否已读" align="center" prop="readStatus" width="80">
        <template v-slot="scope">
          ...
          <span v-if="scope.row.readStatus === 1"><el-tag type="success">已读</el-tag></span>
        </template>
      </el-table-column>
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      // 执行查询
      getMyNotifyMessagePage(this.addDateRange(this.queryParams, this.dateRange)).then(response => {
